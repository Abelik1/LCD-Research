...
#     ### Extra filtering ###
#     # # Convert 'Transmittance' column back to numeric for filtering
#     # df_short['Transmittance'] = pd.to_numeric(df_short['Transmittance'])
    
#     # # Remove rows with negative 'Transmittance' values
#     # df_short = df_short[df_short['Transmittance'] >= 0]
...
# # Replace these with the actual paths to your folders
# input_folder_path = r'D:\ASCIIDATA\2024_07_24_RT13091'
# output_folder_path = r'D:\ORIGINDATA\2024_07_24_RT13091'
